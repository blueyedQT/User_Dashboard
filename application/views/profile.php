	...
	<div class="container">
		...
		<div class="row">
			...
			<form role="form" action="/post_message/<?php echo $user_info['id'] ?>" method="post">
				...
				<button class="col-md-2 col-md-offset-10 btn btn-success" type="submit">Post Message</button>
			</form>
		</div>
...
<!-- 		<div class="message_container">
 -->
		...
		<div class="row outline message"><?php echo $message['message'] ?></div>
...
<?php 			if(!empty($comments)) {
		...
		<div class="row">
			<div class="outline message col-md-11 col-md-offset-1"><?php echo $comment['comment'] ?></div>
		</div>	
<?php 					}
					}
				} ?>
